...
async function main() {
  ...
  // 2. Insert the KPIs Dataset (from the assignment image)
  await prisma.route.createMany({
    data: [
      ...
      { routeId: 'R004', vesselType: 'RoRo', fuelType: 'HFO', year: 2025, ghgIntensity: 89.2, fuelConsumption: 4900, distance: 11800, totalEmissions: 4300, isBaseline: true }, // Set R004 as baseline
